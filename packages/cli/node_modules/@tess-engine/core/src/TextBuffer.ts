class TextBuffer {
	 ...
	 */
	public flush(): string {
		let result = this.onFlush(this._buffer, false) as string;
		this.empty();
		return result;
	}
	 ...
	 * @returns {string[]}
	 */
	public flushArray(): string[] {
		let result = this.onFlush(this._buffer, true) as string[];
		this.empty();
		return result;
	}
	 ...
	 * @returns {string}
	 */
	public onFlush(buffer: string[], asArray: boolean = false): string | string[] {
