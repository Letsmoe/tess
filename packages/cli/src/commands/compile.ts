...
export function compile(args: { default: string[], config?: string, out?: string, force?: boolean }) {
...
function compileContent(content: string, fileName: string = null, environment: {[key: string]: any} = {}): Promise<string> {
